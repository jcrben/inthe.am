...
stat /var/www/twweb/LICENSE /var/www/twweb/LICENSE2
stat /var/www/twweb/scripts/vagrant/environment_variables.sh
stat /var/www/twweb/environment_variables.sh
# cp /var/www/twweb/scripts/generate_task_scss.py $MAIN_DIR
cp -n /var/www/twweb/scripts/vagrant/environment_variables.sh $MAIN_DIR
# if [ ! -z "$TRAVIS" ]; then
